            ...
            <div class="row h-100 align-items-center">
                <div class="col-12">
                    <div class="breadcrumb-content text-center">
                        <h2 class="page-title">Tour Cart</h2>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-lg-12">
                    ...
                    <!-- Single Room Area -->
                    <div class="cartDiv single-room-area d-flex align-items-center mb-50 wow">
                        
                        <!-- Room Thumbnail -->
                        <div class="room-thumbnail">
                            <img class="" src="img/bg-img/19.jpg" alt="">
                        </div>
                        ...
                        <div class="tour-select">
                            <button style="" type="button " class="btn btn-danger" aria-label="Close">
                    ...
                    <div class="cartDiv single-room-area d-flex align-items-center mb-50 wow">
                        ...
                        <div class="room-content">
                            ...
                            <p>ur compact island offers an array of fauna and flora in which authentic wild life is abundant . highlighted as one of the top five global diversity hotspots , sri Lanka encompasses 25 national parks which ..</p>
                            <h4> <span> </span></h4>
                            <a href="#" class="btn view-detail-btn">View Details <i class="fa fa-long-arrow-right" aria-hidden="true"></i></a>
                        </div>
